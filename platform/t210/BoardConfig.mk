...
TARGET_SPECIFIC_HEADER_PATH := device/nvidia/platform/t210/include
...
# Assert
TARGET_OTA_ASSERT_DEVICE := darcy,foster,loki,t210
...
BOARD_BLUETOOTH_BDROID_BUILDCFG_INCLUDE_DIR ?= device/nvidia/platform/t210/comms
...
# Recovery
TARGET_RECOVERY_FSTAB := device/nvidia/platform/t210/initfiles/fstab.foster
...
TARGET_LIBINIT_DEFINES_FILE := device/nvidia/platform/t210/init/init_foster.cpp

# Override common releasetools
# TARGET_RELEASETOOLS_EXTENSIONS := device/nvidia/platform/t210/releasetools

# TWRP Support
ifeq ($(WITH_TWRP),true)
-include device/nvidia/platform/t210/twrp/twrp.mk
endif
